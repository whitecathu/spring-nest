...
export const backgroundProfiles: Record<BackgroundProfileKey, BackgroundProfile> = {
  'home-garden': {
    ...
    intensity: 'balanced',
    light: {
      base: 'linear-gradient(135deg, oklch(98% 0.018 88), oklch(96% 0.035 144) 48%, oklch(97% 0.028 43))',
      wash: 'radial-gradient(circle at 18% 20%, oklch(88% 0.08 142 / 0.28), transparent 32%), radial-gradient(circle at 78% 18%, oklch(88% 0.07 48 / 0.24), transparent 34%)',
      halo: [
        'oklch(86% 0.09 143 / 0.34)',
        'oklch(89% 0.07 57 / 0.28)',
        'oklch(83% 0.07 198 / 0.18)',
      ],
    ...
    dark: {
      base: 'linear-gradient(135deg, oklch(18% 0.02 148), oklch(13% 0.017 164) 52%, oklch(17% 0.022 91))',
      wash: 'radial-gradient(circle at 18% 22%, oklch(57% 0.1 145 / 0.18), transparent 34%), radial-gradient(circle at 78% 20%, oklch(78% 0.12 82 / 0.14), transparent 30%)',
      halo: [
        'oklch(48% 0.09 145 / 0.24)',
        'oklch(70% 0.09 92 / 0.14)',
        'oklch(55% 0.08 210 / 0.13)',
      ],
  ...
  'tools-flow': {
    ...
    intensity: 'quiet',
    light: {
      base: 'linear-gradient(135deg, oklch(98% 0.012 102), oklch(96% 0.018 166) 55%, oklch(97% 0.014 215))',
      wash: 'radial-gradient(circle at 20% 18%, oklch(84% 0.055 152 / 0.2), transparent 31%), radial-gradient(circle at 82% 70%, oklch(83% 0.045 214 / 0.16), transparent 32%)',
      halo: [
        'oklch(84% 0.06 150 / 0.24)',
        'oklch(83% 0.05 214 / 0.18)',
        'oklch(92% 0.04 88 / 0.18)',
      ],
    ...
    dark: {
      base: 'linear-gradient(135deg, oklch(16% 0.016 154), oklch(13% 0.018 190) 58%, oklch(15% 0.014 105))',
      wash: 'radial-gradient(circle at 18% 18%, oklch(53% 0.08 150 / 0.14), transparent 32%), radial-gradient(circle at 82% 70%, oklch(60% 0.07 220 / 0.12), transparent 34%)',
      halo: [
        'oklch(52% 0.08 152 / 0.18)',
        'oklch(60% 0.07 214 / 0.13)',
        'oklch(70% 0.06 90 / 0.1)',
      ],
  ...
  'games-playful': {
    ...
    intensity: 'lively',
    light: {
      base: 'linear-gradient(135deg, oklch(98% 0.016 75), oklch(96% 0.032 151) 45%, oklch(96% 0.032 22))',
      wash: 'radial-gradient(circle at 18% 24%, oklch(84% 0.12 151 / 0.22), transparent 32%), radial-gradient(circle at 76% 18%, oklch(84% 0.11 34 / 0.18), transparent 30%), radial-gradient(circle at 72% 78%, oklch(82% 0.08 255 / 0.16), transparent 34%)',
      halo: [
        'oklch(84% 0.11 151 / 0.28)',
        'oklch(86% 0.1 35 / 0.22)',
        'oklch(82% 0.09 250 / 0.18)',
      ],
    ...
    dark: {
      base: 'linear-gradient(135deg, oklch(16% 0.022 151), oklch(13% 0.02 250) 48%, oklch(16% 0.024 35))',
      wash: 'radial-gradient(circle at 18% 24%, oklch(57% 0.12 151 / 0.16), transparent 33%), radial-gradient(circle at 76% 18%, oklch(70% 0.12 35 / 0.12), transparent 32%), radial-gradient(circle at 72% 78%, oklch(61% 0.1 255 / 0.13), transparent 34%)',
  ...
  'favorites-glow': {
    ...
    intensity: 'quiet',
    light: {
      base: 'linear-gradient(135deg, oklch(98% 0.014 70), oklch(96% 0.026 25) 52%, oklch(97% 0.016 150))',
      wash: 'radial-gradient(circle at 32% 22%, oklch(88% 0.08 45 / 0.22), transparent 34%), radial-gradient(circle at 76% 72%, oklch(88% 0.07 145 / 0.18), transparent 32%)',
      halo: [
        'oklch(87% 0.08 45 / 0.24)',
        'oklch(88% 0.07 145 / 0.2)',
        'oklch(86% 0.06 288 / 0.12)',
      ],
    ...
    dark: {
      base: 'linear-gradient(135deg, oklch(16% 0.018 50), oklch(12% 0.018 150) 55%, oklch(16% 0.02 286))',
      wash: 'radial-gradient(circle at 32% 22%, oklch(70% 0.09 55 / 0.14), transparent 34%), radial-gradient(circle at 76% 72%, oklch(64% 0.08 145 / 0.12), transparent 32%)',
      halo: [
        'oklch(70% 0.09 55 / 0.14)',
        'oklch(62% 0.08 145 / 0.14)',
        'oklch(62% 0.07 286 / 0.12)',
      ],
  ...
  'not-found-path': {
    ...
    intensity: 'balanced',
    light: {
      base: 'linear-gradient(145deg, oklch(98% 0.016 82), oklch(95% 0.03 140), oklch(97% 0.018 58))',
      wash: 'radial-gradient(circle at 42% 74%, oklch(76% 0.08 85 / 0.2), transparent 30%), radial-gradient(circle at 18% 18%, oklch(86% 0.08 142 / 0.18), transparent 34%)',
      halo: [
        'oklch(86% 0.08 142 / 0.22)',
        'oklch(80% 0.08 85 / 0.18)',
        'oklch(88% 0.07 40 / 0.14)',
      ],
    ...
    dark: {
      base: 'linear-gradient(145deg, oklch(15% 0.018 122), oklch(12% 0.02 160), oklch(16% 0.018 70))',
      wash: 'radial-gradient(circle at 42% 74%, oklch(62% 0.08 85 / 0.12), transparent 30%), radial-gradient(circle at 18% 18%, oklch(58% 0.08 142 / 0.14), transparent 34%)',
  ...
  'offline-cabin': {
    ...
    intensity: 'quiet',
    light: {
      base: 'linear-gradient(135deg, oklch(97% 0.016 78), oklch(95% 0.018 130) 58%, oklch(96% 0.016 45))',
      wash: 'radial-gradient(circle at 50% 52%, oklch(84% 0.07 68 / 0.28), transparent 28%), radial-gradient(circle at 22% 18%, oklch(86% 0.06 145 / 0.16), transparent 34%)',
      halo: [
        'oklch(84% 0.08 70 / 0.24)',
        'oklch(82% 0.06 145 / 0.16)',
        'oklch(86% 0.05 210 / 0.1)',
      ],
    ...
    dark: {
      base: 'linear-gradient(135deg, oklch(13% 0.018 76), oklch(11% 0.018 145) 58%, oklch(14% 0.018 38))',
      wash: 'radial-gradient(circle at 50% 52%, oklch(72% 0.09 70 / 0.16), transparent 26%), radial-gradient(circle at 22% 18%, oklch(56% 0.07 145 / 0.1), transparent 34%)',
      halo: [
        'oklch(72% 0.09 70 / 0.13)',
        'oklch(56% 0.07 145 / 0.11)',
        'oklch(58% 0.06 210 / 0.09)',
      ],
  ...
  'search-focus': {
    ...
    intensity: 'quiet',
    light: {
      base: 'linear-gradient(135deg, oklch(98% 0.012 95), oklch(96% 0.02 155), oklch(97% 0.014 218))',
      wash: 'radial-gradient(circle at 50% 30%, oklch(84% 0.07 155 / 0.24), transparent 33%)',
      halo: [
        'oklch(84% 0.07 155 / 0.25)',
        'oklch(84% 0.05 218 / 0.14)',
        'oklch(90% 0.04 85 / 0.12)',
      ],
    ...
    dark: {
      base: 'linear-gradient(135deg, oklch(15% 0.016 155), oklch(12% 0.018 210), oklch(14% 0.015 95))',
      wash: 'radial-gradient(circle at 50% 30%, oklch(58% 0.08 155 / 0.14), transparent 33%)',
      halo: [
        'oklch(58% 0.08 155 / 0.15)',
        'oklch(58% 0.06 218 / 0.11)',
        'oklch(70% 0.05 85 / 0.09)',
      ],
  ...
  'empty-quiet': {
    ...
    light: {
      ...
      wash: 'radial-gradient(circle at 44% 28%, oklch(86% 0.06 142 / 0.16), transparent 36%), radial-gradient(circle at 78% 78%, oklch(88% 0.05 70 / 0.12), transparent 32%)',
      halo: [
        'oklch(86% 0.06 142 / 0.16)',
        'oklch(88% 0.05 70 / 0.12)',
        'oklch(84% 0.04 220 / 0.08)',
      ],
    ...
    dark: {
      ...
      wash: 'radial-gradient(circle at 44% 28%, oklch(58% 0.06 142 / 0.1), transparent 36%), radial-gradient(circle at 78% 78%, oklch(68% 0.05 70 / 0.08), transparent 32%)',
      halo: [
        'oklch(58% 0.06 142 / 0.1)',
        'oklch(68% 0.05 70 / 0.08)',
        'oklch(58% 0.04 220 / 0.08)',
      ],
  ...
  'calculator-grid': {
    ...
    light: {
      ...
      wash: 'radial-gradient(circle at 50% 22%, oklch(84% 0.06 205 / 0.18), transparent 34%), radial-gradient(circle at 76% 74%, oklch(86% 0.06 142 / 0.16), transparent 30%)',
      halo: [
        'oklch(84% 0.06 205 / 0.18)',
        'oklch(86% 0.06 142 / 0.16)',
        'oklch(88% 0.04 80 / 0.12)',
      ],
    ...
    dark: {
      ...
      wash: 'radial-gradient(circle at 50% 22%, oklch(58% 0.07 205 / 0.12), transparent 34%), radial-gradient(circle at 76% 74%, oklch(57% 0.07 142 / 0.1), transparent 30%)',
      halo: [
        'oklch(58% 0.07 205 / 0.12)',
        'oklch(57% 0.07 142 / 0.1)',
        'oklch(70% 0.05 80 / 0.08)',
      ],
  ...
  'pomodoro-rings': {
    ...
    light: {
      ...
      halo: [
        'oklch(85% 0.08 34 / 0.22)',
        'oklch(86% 0.06 88 / 0.14)',
        'oklch(86% 0.05 145 / 0.11)',
      ],
    ...
    dark: {
      ...
      halo: [
        'oklch(62% 0.09 34 / 0.13)',
        'oklch(70% 0.06 88 / 0.09)',
        'oklch(58% 0.05 145 / 0.08)',
      ],
  ...
  'color-halo': {
    ...
    intensity: 'balanced',
    light: {
      base: 'linear-gradient(135deg, oklch(98% 0.018 40), oklch(96% 0.03 150), oklch(96% 0.03 255))',
      wash: 'conic-gradient(from 90deg at 52% 40%, oklch(86% 0.1 25 / 0.2), oklch(84% 0.12 145 / 0.18), oklch(82% 0.1 260 / 0.16), oklch(86% 0.1 25 / 0.2))',
    ...
    dark: {
      base: 'linear-gradient(135deg, oklch(14% 0.018 40), oklch(12% 0.022 150), oklch(13% 0.022 255))',
      wash: 'conic-gradient(from 90deg at 52% 40%, oklch(62% 0.12 25 / 0.12), oklch(58% 0.12 145 / 0.11), oklch(58% 0.1 260 / 0.11), oklch(62% 0.12 25 / 0.12))',
      halo: [
        'oklch(62% 0.12 25 / 0.12)',
        'oklch(58% 0.12 145 / 0.11)',
        'oklch(58% 0.1 260 / 0.11)',
      ],
  ...
  'qr-dots': {
    ...
    light: {
      ...
      halo: [
        'oklch(83% 0.07 185 / 0.18)',
        'oklch(86% 0.06 145 / 0.14)',
        'oklch(88% 0.04 85 / 0.1)',
      ],
    ...
    dark: {
      ...
      halo: [
        'oklch(58% 0.07 185 / 0.12)',
        'oklch(57% 0.06 145 / 0.1)',
        'oklch(70% 0.04 85 / 0.08)',
      ],
  ...
  'json-scan': {
    ...
    light: {
      ...
      halo: [
        'oklch(83% 0.08 150 / 0.18)',
        'oklch(84% 0.06 210 / 0.12)',
        'oklch(88% 0.04 80 / 0.1)',
      ],
    ...
    dark: {
      ...
      halo: [
        'oklch(57% 0.08 150 / 0.12)',
        'oklch(58% 0.06 210 / 0.1)',
        'oklch(70% 0.04 80 / 0.08)',
      ],
  ...
  'document-pages': {
    ...
    intensity: 'quiet',
    light: {
      base: 'linear-gradient(135deg, oklch(98% 0.012 84), oklch(96% 0.018 110), oklch(97% 0.012 170))',
      wash: 'radial-gradient(circle at 50% 24%, oklch(86% 0.05 95 / 0.18), transparent 34%)',
      halo: [
        'oklch(86% 0.05 95 / 0.18)',
        'oklch(86% 0.05 150 / 0.12)',
        'oklch(84% 0.04 210 / 0.1)',
      ],
    ...
    dark: {
      base: 'linear-gradient(135deg, oklch(14% 0.014 84), oklch(12% 0.016 145), oklch(13% 0.014 210))',
  ...
  'nature-wind': {
    ...
    intensity: 'balanced',
    light: {
      base: 'linear-gradient(135deg, oklch(98% 0.014 92), oklch(95% 0.032 142), oklch(97% 0.018 198))',
      wash: 'radial-gradient(circle at 22% 20%, oklch(84% 0.08 142 / 0.22), transparent 34%), radial-gradient(circle at 76% 72%, oklch(84% 0.06 198 / 0.14), transparent 34%)',
      halo: [
        'oklch(84% 0.08 142 / 0.22)',
        'oklch(84% 0.06 198 / 0.14)',
        'oklch(88% 0.05 70 / 0.1)',
      ],
    ...
    dark: {
      base: 'linear-gradient(135deg, oklch(14% 0.016 142), oklch(12% 0.018 198), oklch(13% 0.016 90))',
      wash: 'radial-gradient(circle at 22% 20%, oklch(57% 0.08 142 / 0.13), transparent 34%), radial-gradient(circle at 76% 72%, oklch(58% 0.06 198 / 0.1), transparent 34%)',
      halo: [
        'oklch(57% 0.08 142 / 0.13)',
        'oklch(58% 0.06 198 / 0.1)',
        'oklch(70% 0.05 70 / 0.08)',
      ],
  ...
  'playful-pop': {
    ...
    intensity: 'lively',
    light: {
      base: 'linear-gradient(135deg, oklch(98% 0.016 70), oklch(96% 0.03 146), oklch(96% 0.028 25))',
      wash: 'radial-gradient(circle at 22% 20%, oklch(84% 0.1 146 / 0.2), transparent 34%), radial-gradient(circle at 76% 72%, oklch(86% 0.1 30 / 0.16), transparent 34%)',
    ...
    dark: {
      base: 'linear-gradient(135deg, oklch(14% 0.018 146), oklch(12% 0.019 250), oklch(14% 0.018 30))',
      wash: 'radial-gradient(circle at 22% 20%, oklch(58% 0.1 146 / 0.12), transparent 34%), radial-gradient(circle at 76% 72%, oklch(68% 0.1 30 / 0.1), transparent 34%)',
  ...
  'magic-stars': {
    ...
    intensity: 'balanced',
    light: {
      base: 'linear-gradient(135deg, oklch(98% 0.014 82), oklch(96% 0.022 145), oklch(97% 0.016 285))',
      wash: 'radial-gradient(circle at 25% 18%, oklch(86% 0.08 145 / 0.18), transparent 34%), radial-gradient(circle at 76% 70%, oklch(84% 0.07 285 / 0.12), transparent 34%)',
      halo: [
        'oklch(86% 0.08 145 / 0.18)',
        'oklch(84% 0.07 285 / 0.12)',
        'oklch(88% 0.06 60 / 0.12)',
      ],
    ...
    dark: {
      base: 'linear-gradient(135deg, oklch(13% 0.018 145), oklch(11% 0.019 285), oklch(14% 0.016 70))',
      wash: 'radial-gradient(circle at 25% 18%, oklch(58% 0.08 145 / 0.12), transparent 34%), radial-gradient(circle at 76% 70%, oklch(58% 0.07 285 / 0.1), transparent 34%)',
  ...
  'tech-grid': {
    ...
    light: {
      ...
      halo: [
        'oklch(82% 0.06 215 / 0.16)',
        'oklch(86% 0.06 150 / 0.12)',
        'oklch(88% 0.04 80 / 0.08)',
      ],
    ...
    dark: {
      ...
      halo: [
        'oklch(58% 0.06 215 / 0.11)',
        'oklch(58% 0.06 150 / 0.1)',
        'oklch(70% 0.04 80 / 0.07)',
      ],
  ...
  'memory-cards': {
    ...
    intensity: 'balanced',
    light: {
      base: 'linear-gradient(135deg, oklch(98% 0.014 84), oklch(96% 0.026 150), oklch(97% 0.018 290))',
      wash: 'radial-gradient(circle at 22% 20%, oklch(84% 0.08 150 / 0.18), transparent 34%), radial-gradient(circle at 76% 70%, oklch(84% 0.07 290 / 0.12), transparent 34%)',
      halo: [
        'oklch(84% 0.08 150 / 0.18)',
        'oklch(84% 0.07 290 / 0.12)',
        'oklch(88% 0.06 50 / 0.1)',
      ],
    ...
    dark: {
      base: 'linear-gradient(135deg, oklch(13% 0.018 150), oklch(12% 0.019 290), oklch(14% 0.016 50))',
      wash: 'radial-gradient(circle at 22% 20%, oklch(58% 0.08 150 / 0.12), transparent 34%), radial-gradient(circle at 76% 70%, oklch(58% 0.07 290 / 0.1), transparent 34%)',
      halo: [
        'oklch(58% 0.08 150 / 0.12)',
        'oklch(58% 0.07 290 / 0.1)',
        'oklch(72% 0.07 50 / 0.08)',
      ],
  ...
  'snake-path': {
    ...
    light: {
      ...
      halo: [
        'oklch(84% 0.09 142 / 0.2)',
        'oklch(86% 0.06 85 / 0.12)',
        'oklch(84% 0.04 220 / 0.08)',
      ],
    ...
    dark: {
      ...
      halo: [
        'oklch(58% 0.09 142 / 0.12)',
        'oklch(70% 0.06 85 / 0.08)',
        'oklch(58% 0.04 220 / 0.07)',
      ],
  ...
  'mines-grid': {
    ...
    light: {
      ...
      halo: [
        'oklch(84% 0.04 205 / 0.14)',
        'oklch(86% 0.05 142 / 0.1)',
        'oklch(88% 0.04 80 / 0.08)',
      ],
    ...
    dark: {
      ...
      halo: [
        'oklch(58% 0.05 205 / 0.1)',
        'oklch(58% 0.05 142 / 0.08)',
        'oklch(70% 0.04 80 / 0.07)',
      ],
  ...
  'bubble-rise': {
    ...
    intensity: 'lively',
    light: {
      base: 'linear-gradient(135deg, oklch(98% 0.012 85), oklch(96% 0.028 190), oklch(97% 0.018 150))',
      wash: 'radial-gradient(circle at 24% 72%, oklch(84% 0.08 190 / 0.18), transparent 34%), radial-gradient(circle at 76% 22%, oklch(84% 0.09 150 / 0.16), transparent 34%)',
      halo: [
        'oklch(84% 0.08 190 / 0.18)',
        'oklch(84% 0.09 150 / 0.16)',
        'oklch(86% 0.08 34 / 0.1)',
      ],
    ...
    dark: {
      base: 'linear-gradient(135deg, oklch(13% 0.018 190), oklch(12% 0.019 150), oklch(14% 0.016 34))',
      wash: 'radial-gradient(circle at 24% 72%, oklch(58% 0.08 190 / 0.12), transparent 34%), radial-gradient(circle at 76% 22%, oklch(58% 0.09 150 / 0.1), transparent 34%)',
      halo: [
        'oklch(58% 0.08 190 / 0.12)',
        'oklch(58% 0.09 150 / 0.1)',
        'oklch(68% 0.08 34 / 0.08)',
      ],
  ...
  'detail-calm': {
    ...
    dark: {
      ...
      halo: [
        'oklch(58% 0.06 145 / 0.11)',
        'oklch(70% 0.05 70 / 0.08)',
        'oklch(58% 0.04 210 / 0.08)',
      ],
