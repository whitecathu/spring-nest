  ...
  return (
    <div className="max-w-[1200px] mx-auto px-6 py-16 w-full">
      <SEO
        ...
        description={t(
          '了解 Spring Nest 春日小筑——一个治愈系数字角落，提供实用工具与休闲小游戏。',
          'Learn about Spring Nest — a healing digital corner with practical tools and casual games.',
        )}
      />
      {/* Header Section */}
      <header className="text-center mb-24 relative forest-readable-hero py-8">
        <h1 className="text-5xl font-black forest-page-title mb-6 flex items-center justify-center gap-4 tracking-tight">
          {t('关于我们', 'About Us')}
          <Heart className="w-10 h-10 fill-tertiary text-tertiary animate-pulse" />
        </h1>
        <p className="font-sans font-medium forest-page-subtitle text-xl">
          {t(
            '以春日之名，做有温度的APP合集',
            'In the name of spring, a heartwarming app collection',
          )}
        </p>

        {/* Animated Background Decor */}
        <div
          className="absolute -top-10 -left-10 text-primary-fixed-dim/20 pointer-events-none"
          aria-hidden="true"
        >
          <Cloud className="w-16 h-16 fill-current" />
        </div>
        <div
          className="absolute top-20 -right-10 text-primary-container/25 pointer-events-none"
          aria-hidden="true"
        >
      ...
      <section className="mb-16 relative">
        <div className="w-full aspect-[21/9] rounded-[48px] overflow-hidden relative shadow-2xl group">
          ...
          <div className="absolute bottom-12 left-12 glass-card p-8 rounded-3xl max-w-md hidden lg:block">
            ...
            <p className="text-on-surface-variant font-sans italic">
              {t(
                '"像种子一样在春天发芽，在这里发现让生活更美好的工具。"',
                '"Sprouting in spring like a seed, discover tools that make life better."',
              )}
            </p>
          </div>
        </div>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-y-16 lg:gap-x-12 mb-32">
        ...
        <div className="lg:col-span-7 flex flex-col justify-center">
          ...
          <h2 className="text-4xl font-extrabold text-on-surface mb-8 leading-tight">
            {t('发现美好数字生活，', 'Discover a beautiful digital life,')}
            <br />
            <span className="text-primary">
              {t('从指尖的温润开始。', 'starting from the warmth of your fingertips.')}
            </span>
          </h2>
          <p className="text-lg text-on-surface-variant leading-relaxed mb-6 font-medium">
            {t(
              '在这个信息爆炸的时代，我们希望成为您数字生活中的一处静谧角落。春日小筑不仅仅是一个APP合集，它是一个精心布置的花园，每一款收录的应用都是我们细心栽培的种子。',
              'In this era of information explosion, we hope to be a quiet corner in your digital life. Spring Nest is not just an app collection; it is a carefully arranged garden, and every included application is a seed we have carefully cultivated.',
            )}
          </p>
        </div>
        ...
        <div className="lg:col-span-5 space-y-8 lg:mt-12">
          <div className="glass-card p-10 rounded-[40px] border-l-8 border-primary">
            ...
            <p className="text-on-surface-variant leading-loose font-medium">
              {t(
                '筛选并呈现那些具有独特设计美学、注重用户隐私、且能切实提升生活幸福感的优质数字工具。我们相信，好的应用应该像春风一样，温柔地融入您的生活。',
                'Filter and present high-quality digital tools that have unique design aesthetics, focus on user privacy, and can effectively enhance happiness in life. We believe good applications should gently blend into your life like the spring breeze.',
              )}
            </p>
          </div>
          ...
          <div className="bg-surface-container-high p-10 rounded-[40px] border-l-8 border-tertiary">
            ...
            <p className="text-on-surface-variant leading-loose font-medium">
              {t(
                '构建一个充满温度的数字社区，让每一位探索者都能在这里找到属于自己的那份从容与治愈，共同分享数字生活中的点滴美好。',
                'Build a heartwarming digital community where every explorer can find their own calmness and healing, and share the little beautiful things in digital life together.',
              )}
            </p>
          </div>
        </div>
        ...
        <div className="glass-card rounded-[48px] p-16 text-center relative overflow-hidden group">
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl text-on-surface-variant max-w-xl mx-auto mb-12 font-medium">
              {t(
                '无论是想要推荐好用的应用，还是与我们分享您的使用感受，我们都期待着您的来信。',
                'Whether you want to recommend a useful app or share your experience, we look forward to hearing from you.',
              )}
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-10">
              ...
              >
                ...
                <span className="font-semibold text-on-surface">
                  {copied ? t('微信号已复制！', 'WeChat copied!') : 'WeChat: SpringNest_App'}
                </span>
              </div>
            </div>
