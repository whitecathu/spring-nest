...
export default function Scanner({ onBack }: { onBack: () => void }) {
  ...
  // Restart camera when facingMode changes and no captured image
  useEffect(() => {
  ...
  return (
    <div className="flex-grow max-w-md mx-auto w-full px-4 py-8">
      ...
      >
        ...
        {/* Filter Controls (only when image captured) */}
        {capturedImage && (
          <motion.div
        ...
        {/* Camera not active and no image: show upload fallback */}
