...
export default function SearchResults() {
  ...
  return (
    <div className="flex-grow w-full max-w-[900px] mx-auto px-6 py-10">
      ...
      {/* Results List */}
      {allResults.length > 0 ? (
        <div key={`${activeType}-${activeSort}`} className="space-y-4">
...
function SearchResultCard({
  ...
  return (
    <div className="block bg-white dark:bg-surface-container-high/20 rounded-2xl p-5 shadow-sm border border-surface-variant/20 hover:shadow-md hover:border-primary/20 transition-all duration-300 group">
