  ...
  return (
    ...
    >
      ...
      <div className="space-y-4">
        <motion.div variants={itemVariants}>
          ...
          >
            ...
            <p className="text-sm text-secondary mt-4">
              {t('我们保留随时修改、暂停或终止任何服务的权利。', 'We reserve the right to modify, suspend, or terminate any service at any time.')}
            </p>
          </Section>
        </motion.div>
        ...
        <motion.div variants={itemVariants}>
          ...
          >
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>{t('提供真实、准确的注册信息', 'Provide truthful and accurate registration information')}</li>
              <li>{t('妥善保管您的账户密码，不与他人共享', 'Safeguard your account password and not share it with others')}</li>
              <li>{t('不利用我们的服务从事任何违法或有害活动', 'Not use our services for any illegal or harmful activities')}</li>
              <li>{t('不尝试攻击、破坏或干扰我们的服务', 'Not attempt to attack, damage, or interfere with our services')}</li>
              <li>{t('不使用自动化工具大量访问或滥用我们的服务', 'Not use automated tools to access or abuse our services in bulk')}</li>
              <li>{t('不侵犯其他用户的权利和隐私', 'Not infringe on the rights and privacy of other users')}</li>
            </ul>
            <p className="text-sm text-secondary mt-4">
              {t('如发现违规行为，我们有权暂停或终止您的账户。', 'If violations are found, we reserve the right to suspend or terminate your account.')}
            </p>
          </Section>
        </motion.div>
        ...
        <motion.div variants={itemVariants}>
          ...
          >
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>{t('复制、修改或分发我们的代码或内容', 'Copy, modify, or distribute our code or content')}</li>
              <li>{t('反向工程、反编译或反汇编我们的软件', 'Reverse engineer, decompile, or disassemble our software')}</li>
              <li>{t('移除或修改任何版权声明或标识', 'Remove or modify any copyright notices or标识')}</li>
              <li>{t('将我们的服务用于商业目的（未经授权）', 'Use our services for commercial purposes (without authorization)')}</li>
            </ul>
          </Section>
        </motion.div>
        ...
        <motion.div variants={itemVariants}>
          ...
          >
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>{t('服务的准确性、可靠性或完整性', 'The accuracy, reliability, or completeness of the service')}</li>
              <li>{t('服务不会中断或无错误', 'That the service will be uninterrupted or error-free')}</li>
              <li>{t('通过服务获得的结果的准确性', 'The accuracy of results obtained through the service')}</li>
            </ul>
            <p className="text-sm text-secondary mt-4">
              {t(
        ...
        <motion.div variants={itemVariants}>
          ...
          >
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>{t('长期不活跃（超过 2 年未登录）', 'Long-term inactivity (not logged in for over 2 years)')}</li>
            </ul>
            <p className="text-sm text-secondary mt-4">
              {t('账户终止后，您的数据将被删除，且无法恢复。', 'After account termination, your data will be deleted and cannot be recovered.')}
            </p>
          </Section>
        </motion.div>
      ...
      <motion.footer variants={itemVariants} className="text-center mt-16 text-secondary text-sm">
        <p>{t('本服务条款自发布之日起生效。', 'These terms of service are effective from the date of publication.')}</p>
      </motion.footer>
    </motion.div>
  );
}
