module.exports = {
  "generatedAt": "2026-07-26T10:37:28.123Z",
  "tabs": [
    {
      "id": "discover",
      "text": "发现",
  ...
  "tools": [
    ...
    },
    {
      ...
      "title": "复习小筑",
      "titleEn": "Review Nest",
      "description": "导入 txt、md、csv、json 题库，整理成可搜索、可复习的本地学习卡片（刷题 / 错题 / 收藏 / 统计）。",
      "descriptionEn": "Import txt, md, csv, and json question banks into searchable local study cards with quiz, wrong-book, favorites, and stats.",
      "category": "学习写作",
      "categoryEn": "Study & Writing",
      "tags": [
        "question bank",
